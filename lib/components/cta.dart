  ...
  Iterable<Component> build(BuildContext context) sync* {
    yield section([
      div(
        ...
        [
          img(
            classes: "absolute z-0 h-125 d:h-143  stroke-3 stroke-green-70 2xl:stroke-5 top-[-68px] l:top-[-38px] left-[-109px] l:left-[-69px]",
            src: "images/abstract-left.svg",
          ),
          img(
            classes: "absolute z-0 size-137 l:size-113 d:size-164 right-[-10px] bottom-[-31px] d:right-[-37px] d:bottom-[-52px] ",
            src: "images/petals.svg",
          ),
          div(
            classes: "flex z-1 flex-col items-center gap-10 l:flex-1 self-stretch *:l:text-start",
            [
              h3(
