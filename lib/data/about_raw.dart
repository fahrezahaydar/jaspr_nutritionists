...
final achievementData = [
  {
    ...
    "subtitle": "Our personalized nutrition plans have helped thousands of individuals reach their weight loss goals and maintain a healthy lifestyle.",
  },
  {
    "icon": 'fork.knife',
    "title": "Positive Client Reviews",
    "subtitle": "We have received numerous testimonials from satisfied clients who have experienced significant improvements in their health, weight, and overall well-being through our coaching program.",
  },
  {
    "icon": 'graduationcap.fill',
    "title": "Recognition for Excellence",
    "subtitle": "Nutritionist has been recognized as a leading provider of personalized nutrition coaching, receiving accolades for our innovative approach and commitment to client success.",
  },
  {
    "icon": 'wallet.pass.fill',
    "title": "Collaborate With Top Health Experts.",
    "subtitle": "Nutritionist has established partnerships with respected nutritionists, dietitians, and health experts to ensure that our clients receive the highest quality guidance and support.",
  },
];

var cta = {
  "title": "We Are Proud of Our Achievements",
  "subtitle": "But our ultimate satisfaction comes from seeing our clients achieve their goals and live healthier, happier lives. Join Nutritionist today and embark on your own transformative journey towards optimal health and well-being.",
};
